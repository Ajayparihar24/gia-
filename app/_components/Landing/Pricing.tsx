...
const Pricing = () => {
  return (
    ...
    >
      <motion.div variants={slideIn("left", "tween", 0.2, 1)} className="grid md:grid-cols-2 grid-cols-1">
        <Image
        ...
        <div className="w-full bg-[#111111] lg:px-16 md:px-14 sm:px-8 px-4 py-8 flex flex-col justify-center">
          ...
          <div>
            <Link
              href="/#"
              className="bg-primary text-white py-3 rounded-full px-6  cursor-pointer border text-sm border-white hover:drop-shadow-md hover:border-2 transition duration-300"
            >
