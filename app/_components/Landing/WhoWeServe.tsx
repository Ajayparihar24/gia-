...
const WhoWeServe = () => {
  return (
    ...
    <section className="container py-8">
      <h1 className="md:text-5xl text-4xl font-bold">WHO WE SERVE</h1>

      <div className="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 my-16">
        <Card
          title="Corporate"
  ...
  return (
    <>
      <div className="w-full h-[340px] bg-transparent cursor-pointer group perspective">
        <div className="relative shadow-xl text-white bg-gradient-to-tr from-blue-600 to-blue-700 p-4 rounded preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000">
